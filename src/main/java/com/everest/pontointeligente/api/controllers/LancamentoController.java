...
import com.everest.pontointeligente.api.dtos.LancamentoDto;
...
public class LancamentoController {
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
		...
		Page<Lancamento> lancamentos = this.lancamentoService.buscarLancamentosPorFuncionarioId(funcionarioId, pageRequest);
